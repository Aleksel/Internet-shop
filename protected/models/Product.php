...
class Product extends CActiveRecord {
	...
	return array(
	    ...
	    array('category_id, prise', 'numerical', 'integerOnly' => true),
	    array('title, titletranscript, features, urlpic', 'length', 'max' => 255),
	    array('description', 'safe'),
	    // The following rule is used by search().
	    // Please remove those attributes that should not be searched.
	    array('id, category_id, title, titletranscript, features, prise, urlpic, description', 'safe', 'on' => 'search'),
	);
    }
	...
	return array(
	    'category' => array(self::BELONGS_TO, 'MenuTree', 'category_id'),
	);
    }
